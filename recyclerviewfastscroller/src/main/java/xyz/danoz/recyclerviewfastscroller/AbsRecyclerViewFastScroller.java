    ...
    implements RecyclerViewScroller
{
  ...
  public interface SectionIndexer
  {
    ...
    public Object getSectionObject(int position);
  }
  ...
  */
  ...
  public AbsRecyclerViewFastScroller(Context context, AttributeSet attrs, int defStyleAttr)
  {
    ...
    try
    {
      int layoutResource = attributes.getResourceId(R.styleable.AbsRecyclerViewFastScroller_fast_scroller_layout, getLayoutResourceId());
  ...
  private void updateSectionIndicator(int position, float scrollProgress)
  {
    if (mSectionIndicator != null)
    {
      ...
      if (adapter instanceof SectionIndexer)
      {
        ...
        final Object sectionObject = indexer.getSectionObject(position);
        if (sectionObject != null)
        {
          mSectionIndicator.setSection(sectionObject);
        }
      }
    }
  }
